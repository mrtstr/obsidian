...
### created an adapted version of a struct instance
- using the `..` operator an update version of a [[r struct]] can be created
...
START
Basic
how to create an updated version of a [[r struct]] in [[rust]]
- create a `user2` that is like `user1` but has a different main address
...
### created an adapted version of a struct instance
- using the `..` operator a update version of a [[r struct]] can be created
