...
- protocol in the [[network layers#network layer|network layer]]
...
Back: 
- splitting up packages by the [[routing|router]] that are larger than the maximum package size of the router (MTU) 
