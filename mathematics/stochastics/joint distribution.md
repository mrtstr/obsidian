...
For the bivariante [[random variable]] $X,Y$ with the [[PDF]] $f_{XY}(x,y)$ and the multivariate [[random variable]] $\boldsymbol{X} =X_1,...,X_n$ with the [[PDF]] $f_{\boldsymbol{X}}(\boldsymbol{x})$.
...
\: dx_{2} ... dx_n
$$
- for [[stochastic independent]] [[random variable]] the [[joint distribution]] is the product of the [[PDF|PDFs]]
$$
...
START
Basic
properties (5) of the [[PDF|continuous joint PDF]] or the bivariante [[random variable]] $X,Y$ with the [[PDF]] $f_{XY}(x,y)$ and the multivariate [[random variable]] $\boldsymbol{X} =X_1,...,X_n$ with the [[PDF]] $f_{\boldsymbol{X}}(\boldsymbol{x})$.
