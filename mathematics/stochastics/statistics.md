...
- possible [[statistical estimator]] $T_n(X)= \frac{2}{n}\sum_{i=1}^n X_n$
...
### [[statistical model]] vs [[statistics]]
- a [[statistical model]] is the framework for 
	- describing a random experiment ([[sample space]] for the oberservations $\mathfrak{X}$ with [[sigma algebra]]) 
	- providing a familiy of [[distribution|distributions]] $\mathbb{P}_\theta$ to describe the observations bested on a parameter [[set]] $\vartheta \in \Theta$ from the [[parameter space]]
...
- what kind of model is needed to describe the situation
- how would the [[sample space]] $\mathfrak{X}$ look like?
- how would the [[parameter space]] $\Theta$ look like?
- how would the  [[probability measure]] $\mathbb{P}_\theta$ look like?
- give an possible [[statistical estimator]]
