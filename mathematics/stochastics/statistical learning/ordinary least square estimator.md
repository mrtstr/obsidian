...
- when assuming constant $\hat\Sigma$ we have the following expression for the [[variance]]
...
- given the non centered empirical [[empirical covariance]] $\hat\Sigma$
$$
\hat\Sigma = \frac{1}{n} X^\top X
$$


- bias variance decomposition of the [[ordinary least square estimator]]
- with the [[scalar product]] $\langle a, b\rangle_\hat\Sigma=a^\top\hat\Sigma b$ and the [[norm]]$|| a||_\hat\Sigma^2 =a^\top\hat\Sigma b$ 
...
- what can be done if the problem has a mad condition?
