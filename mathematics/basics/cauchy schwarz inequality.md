...
$$
\left(\sum_{i \in [n]} x_i y_i\right)^2 \leq \left(\sum_{i \in [n]} x_i^2\right) \cdot \left(\sum_{i \in [n]} y_i^2\right)
$$

#### $L^2$ [[norm]] in the [[function space]]
- $f:\Omega \rightarrow \mathbb{R}$ and $g:\Omega \rightarrow \mathbb{R}$
$$
\left(\int_\Omega f(x)g(x) dx \right)^2 \leq \left(\int_\Omega f(x)^2 dx\right) \cdot \left(\int_\Omega g(x)^2 dx\right)
$$
# --------------------
