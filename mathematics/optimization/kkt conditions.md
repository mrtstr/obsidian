...
### interpretation of the kkt conditions
- in the following example with one inequality contraint $h(x)$ we see that the [[gradient]] of the objective function $\nabla f(x)$ and the inequality constraint $\nabla h(x)$ have te point in the exact direction otherwise a step along the edge of $\mathcal{F}$ would improve $f$
- the **stationarity** and **optimality** is satisfied because $\nabla f(x) = \mu \nabla f(x)$ would be statisfied with a positive the multiplier $\mu$ 
- **complementary slackness** and **feasibility** is also satisfied because $h(x)=0$

![[IMG-20240723-WA0001.jpg]]

- in the following example with two inequality contraint $h_1(x)$ and $h_2(x)$ we see that the [[gradient]] of the objective function $\nabla f(x)$ and is a [[linear combinations]] of $\nabla h_1(x)$ and $\nabla h_2(x)$ with positive multipliers $\mu_1$ and $\mu_2$ thus **stationarity** and **optimality** are satisfied
- **complementary slackness** and **feasibility** is also satisfied because $h_1(x)=h_2(x)=0$
...
Basic
[[kkt conditions]]
- interpretation and visulal example for one and two inequality constraints
...
![[IMG-20240723-WA0001 1.jpg]]

- in the following example with two inequality contraint $h_1(x)$ and $h_2(x)$ we see that the [[gradient]] of the objective function $\nabla f(x)$ and is a [[linear combinations]] of $\nabla h_1(x)$ and $\nabla h_2(x)$ with positive multipliers $\mu_1$ and $\mu_2$ thus **stationarity** and **optimality** are satisfied
- **complementary slackness** and **feasibility** is also satisfied because $h_1(x)=h_2(x)=0$

![[IMG-20240723-WA0003 1.jpg]]
