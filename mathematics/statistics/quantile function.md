...
## estimation
- can be [[statistical estimator|estimated]] using [[quantile regression]]
- taking the $q$ smallest value of a [[statistical sample|sample]] $\widehat{Q}_X(q)=\inf\left\{x \mid \frac{1}{n} \sum\limits_{i=1}^n\mathbb{I}[x_i \leq x] \leq q\right\}$
