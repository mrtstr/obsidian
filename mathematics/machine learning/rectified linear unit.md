...
### gated linear unit
- [[rectified linear unit]] has only two modes: either the information is passed completely or is blocked
- [[rectified linear unit#gated linear unit]] adds mechanism that can control the form of information that does thru the node using the [[sigmoid function]]
...
- sale concept as the [[rectified linear unit#gated linear unit]] but the [[sigmoid function]] is replaced with a swish gate
