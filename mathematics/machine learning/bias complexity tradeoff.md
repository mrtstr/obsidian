...
Note: compared to the normal [[bias complexity tradeoff]] we consider the limitations of a [[hypothesis space]] in  $\epsilon_\mathrm{app}$ while before we assumed that the remaining error was just caused by noise in the data

# anki

START
Basic
[[bias complexity tradeoff]] for the case of the [[mean square error]] [[loss function]] 
