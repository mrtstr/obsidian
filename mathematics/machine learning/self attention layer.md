...
- similar to [[self attention layer#multihead self attention layer]] but there is only a single key $K$ and value $V$ that is used for all attention heads
...
- faster than [[self attention layer#multihead self attention layer]] but better quality than [[self attention layer#multi query attention layer]]
