...
- method that makes [[nn transformer block|transformer models]] position aware by including positional information in the attention mechanism of the [[nn self attention layer]]
- replaces the positional encoding component of the input embeddings with for example [[nn sinusoidal positional encoding]] 
...
- generalizes better for unseen sequence lengths than [[nn sinusoidal positional encoding]]
...
![[nn sinusoidal positional encoding#sinusoidal positional encoding]]
...
START
Basic
how is positional information in modern [[nn transformer block|transformer models]] preserved?
