...
- a [[residual block]] is often combined with a [[norm layer]]
- initially the layer norm was applied after the [[residual block]] (post layer norm)
...
START
Basic
[[residual block]] and [[norm layer]]
- benefits of [[residual block]] 
Back: 
### residual block
- skip conception layer in a [[neural network]] 
- adds a layer $F$ that can be bypassed 
