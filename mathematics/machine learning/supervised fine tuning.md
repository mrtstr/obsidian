...
- first step pf phase two of [[LLM training]]
- continue training the [[pretraining|pretrained]] model with the **same next-token prediction loss**, but now on **high-quality instruction–response pairs** instead of raw web text.
