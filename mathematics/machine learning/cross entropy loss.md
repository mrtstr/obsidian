...
- if $y$ is a one hot vector with the value with the index $c$ being the correct class the [[cross entropy loss]] simplifies
...
- when combining the [[cross entropy loss]] with a [[softmax function]] in the output layer, the [[gradient]] with respect to the [[logit]] $z$ with $\hat y=\mathrm{SOFTMAX}(z)$ simplifies to the following
...
- when combining the [[cross entropy loss]] with a [[sigmoid function]] in the output layer, the [[gradient]] with respect to the [[logit]] $z$ with $\hat y=\sigma(z)$ simplifies to the following
...
START
Basic
calculate the [[gradient]] with respect to the [[logit]] $z$ with $\hat y=\sigma(z)$ for the [[cross entropy loss]] with a [[sigmoid function]] in the output layer in a binary classification problem
...
START
Basic
calculate the [[gradient]] with respect to the [[logit]] $z$ with $\hat y=\sigma(z)$ for the [[cross entropy loss]] with a [[softmax function]] in the output layer in a multi class classification
